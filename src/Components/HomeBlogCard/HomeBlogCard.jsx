        ...
        <div className="row info-interactions-row m-0 justify-content-between">
          ...
          <div className="col-lg-2 col-md-2 col-sm-2 p-0">
            <div className="d-flex flex-row justify-content-end g-8">
              <button className={`love btn-blog ${isLove}`} onClick={() => handleToggle(isLove, setIsLove)}>
                <img src={icon1} alt="" />
              </button>
              <button className={`save btn-blog ${isSave}`} onClick={() => handleToggle(isSave, setIsSave)}>
                <img src={icon2} alt="" />
              </button>
            </div>
          </div>
