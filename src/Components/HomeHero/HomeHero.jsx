...
export default function HomeHero() {
    ...
    return (
        <section className='NG-hero mb-150' data-aos="slide-right">
            ...
            <div className="NG-right" data-aos="fade-down" >
                <p>Transform Your ❤️ Health with</p>
                <h2>Personalized Nutrition Coaching</h2>
                <p className='NG-pcontent'>Welcome to Nutritionist, your partner in achieving optimal health through personalized nutrition coaching. Our certified nutritionists are here to guide you on your weight loss journey, providing customized plans and ongoing support. Start your transformation today and experience the power of personalized nutrition coaching.</p>
